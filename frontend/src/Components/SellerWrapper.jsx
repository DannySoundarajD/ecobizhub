// src/Components/SellerWrapper.jsx
import React, { useEffect, useState } from 'react';
import { useNavigate, Outlet } from 'react-router-dom';
import { Loader, AlertCircle } from 'lucide-react';

const SellerWrapper = ({ isLoggedIn, userRole }) => {
    ...
    useEffect(() => {
        ...
        if (userRole === 'seller' || userRole === 'admin') {
            ...
            setLoading(false);
        } else if (isLoggedIn && userRole && userRole !== 'seller') {
            setLoading(false);
            alert("Access Denied. You do not have seller privileges.");
            navigate('/');
